...
use crate::components::parent_child::{
    ...
    parent_child_closure_instead_callback::Parent as ParentClosureInsteadOfCallback,
};

use crate::components::color_tool::color_home::ColoHome;
        ...
        <Router>
            <main id="content">
                <Routes>
                    ...
                    <Route path="/color-home" view=ColoHome/>
